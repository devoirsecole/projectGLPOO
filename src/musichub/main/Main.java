...
public class Main
{
		...
		while (choice.charAt(0)!= 'q') 	{
			switch (choice.charAt(0)) 	{
				...
				case 'c':
					...
					System.out.println("Lyrics path: ");
					String lyrics = scan.nextLine();
                    Song s = new Song (title, artist, length, content, genre,lyrics);
                    theHub.addElement(s);
				...
				case 'e':
					...
					System.out.println("Choose an element to play :");
					String toplay = scan.nextLine();
					try {
						AudioElement toHistory = theHub.playAudioElement(toplay);
						theHub.addToHistory(toHistory);
					}catch (NoElementFoundException ex){
						System.out.println(ex.getMessage());
					}
				...
				case 'i': //history
					...
					System.out.println("See your history");

					System.out.println(theHub.seeHistory());
				...
				case 'm': //affiche les paroles:
					System.out.println("Choose lyrics you want to see");

					String toshow = scan.nextLine();
					theHub.showLyrics(toshow);
	...
	private static void printAvailableCommands() {
		...
		System.out.println("i : see your history");
		System.out.println("m : see lyrics of a song");
		System.out.println("e : choose a song to play");
